...
public class FastScalarSqrtXfci1PluginTest {
	...
	public void test() throws ConnectorException {
		ExternalFunctionConnectorInterface1 function = new FastScalarSqrtXfci1Plugin();
		...
		assertTrue(
			Double.valueOf( Math.sqrt(0.0) ).equals( outputDataContainer.getFloat64ScalarData() )
		);
		...
		function.invoke(new Object[] { outputDataContainer, inputDataContainer });
		assertTrue(
			Double.valueOf( Math.sqrt(1.25) ).equals( outputDataContainer.getFloat64ScalarData() )
		);
		...
		function.invoke(new Object[] { outputDataContainer, inputDataContainer });
		assertTrue(
			Double.valueOf( Math.sqrt(0.25) ).equals( outputDataContainer.getFloat64ScalarData() )
		);
