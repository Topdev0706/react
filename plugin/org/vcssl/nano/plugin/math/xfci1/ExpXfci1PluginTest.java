...
public class ExpXfci1PluginTest {
	...
	public void testSettings() {
		ExternalFunctionConnectorInterface1 function = new ExpXfci1Plugin();

		// Check function name
		// 関数名を検査
		assertEquals("exp", function.getFunctionName());
	...
	public void testDoubleScalar() throws ConnectorException {
		...
		// Check result value
		// 演算結果の値を確認
		Double expected = Double.valueOf(Math.exp(1.0));
	...
	public void testDoubleArray1D() throws ConnectorException {
		...
		// 演算結果[0]の値を確認
		expected = Double.valueOf(Math.exp(1.0));
		actual = Double.valueOf(resultData[0]);
		assertTrue(expected.equals(actual));

		// Check result value[1]
		// 演算結果[1]の値を確認
		expected = Double.valueOf(Math.exp(2.0));
		actual = Double.valueOf(resultData[1]);
		assertTrue(expected.equals(actual));

		// Check result value[2]
		// 演算結果[2]の値を確認
		expected = Double.valueOf(Math.exp(3.0));
	...
	public void testDoubleArray2D() throws ConnectorException {
		...
		// 演算結果[3]の値を確認
		expected = Double.valueOf(Math.exp(4.0));
		actual = Double.valueOf(resultData[3]);
		assertTrue(expected.equals(actual));

		// Check result value[4]
		// 演算結果[4]の値を確認
		expected = Double.valueOf(Math.exp(5.0));
		actual = Double.valueOf(resultData[4]);
		assertTrue(expected.equals(actual));

		// Check result value[5]
		// 演算結果[5]の値を確認
		expected = Double.valueOf(Math.exp(6.0));
