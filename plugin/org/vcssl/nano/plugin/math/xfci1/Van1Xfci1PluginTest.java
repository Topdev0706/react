...
public class Van1Xfci1PluginTest {
	...
	public void testSettings() {
		ExternalFunctionConnectorInterface1 function = new Van1Xfci1Plugin();

		// Check function name
		// 関数名を検査
		assertEquals("van1", function.getFunctionName());
	...
	public void testDoubleSingleArg() throws ConnectorException {
		...
		// Check result value
		// 演算結果の値を確認
		assertTrue(Double.isNaN(resultData[0]));
	}
	...
	public void testDoubleDoubleArgs() throws ConnectorException {
		...
		double van1 = squareDiffSum / (2-1);

		Double expected = Double.valueOf(van1);
