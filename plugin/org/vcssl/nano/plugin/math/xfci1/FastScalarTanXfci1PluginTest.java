...
public class FastScalarTanXfci1PluginTest {
	...
	public void test() throws ConnectorException {
		ExternalFunctionConnectorInterface1 function = new FastScalarTanXfci1Plugin();
		...
		assertTrue(
			Double.valueOf( Math.tan(0.0) ).equals( outputDataContainer.getFloat64ScalarData() )
		);
		...
		function.invoke(new Object[] { outputDataContainer, inputDataContainer });
		assertTrue(
			Double.valueOf( Math.tan(-4.56) ).equals( outputDataContainer.getFloat64ScalarData() )
		);
