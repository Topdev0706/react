...
public class RadXfci1PluginTest {
	...
	public void testDoubleScalar() throws ConnectorException {
		...
		inputDataContainer.setArrayData(new double[] { 180.0 }, 0, ArrayDataAccessorInterface1.ARRAY_LENGTHS_OF_SCALAR);
	...
	public void testDoubleArray1D() throws ConnectorException {
		...
		inputDataContainer.setArrayData(new double[] { 180.0, 90.0, 60.0 }, 0, inputArrayLengths);
	...
	public void testDoubleArray2D() throws ConnectorException {
		...
		inputDataContainer.setArrayData(new double[] { 360.0, 270.0, 180.0, 90.0, 60.0, 30.0 }, 0, inputArrayLengths);
	...
	public void testDoubleArrayElement() throws ConnectorException {
		...
		inputDataContainer.setArrayData(new double[] { 180.0, 360.0, 720.0 }, inputDataOffset, ArrayDataAccessorInterface1.ARRAY_LENGTHS_OF_SCALAR);
