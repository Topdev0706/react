...
public class FastScalarExpXfci1PluginTest {
	...
	public void test() throws ConnectorException {
		ExternalFunctionConnectorInterface1 function = new FastScalarExpXfci1Plugin();
		...
		assertTrue(
			Double.valueOf( Math.exp(1.0) ).equals( outputDataContainer.getFloat64ScalarData() )
		);
		...
		function.invoke(new Object[] { outputDataContainer, inputDataContainer });
		assertTrue(
			Double.valueOf( Math.exp(1.25) ).equals( outputDataContainer.getFloat64ScalarData() )
		);
		...
		function.invoke(new Object[] { outputDataContainer, inputDataContainer });
		assertTrue(
			Double.valueOf( Math.exp(2.5) ).equals( outputDataContainer.getFloat64ScalarData() )
		);
