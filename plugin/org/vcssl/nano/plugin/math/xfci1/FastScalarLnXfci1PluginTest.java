...
public class FastScalarLnXfci1PluginTest {
	...
	public void test() throws ConnectorException {
		ExternalFunctionConnectorInterface1 function = new FastScalarLnXfci1Plugin();
		...
		assertTrue(
			Double.valueOf( Math.log(1.0) ).equals( outputDataContainer.getFloat64ScalarData() )
		);
		...
		function.invoke(new Object[] { outputDataContainer, inputDataContainer });
		assertTrue(
			Double.valueOf( Math.log(1.25) ).equals( outputDataContainer.getFloat64ScalarData() )
		);
		...
		function.invoke(new Object[] { outputDataContainer, inputDataContainer });
		assertTrue(
			Double.valueOf( Math.log(2.5) ).equals( outputDataContainer.getFloat64ScalarData() )
		);
