...
public class HalfUpXvci1Plugin implements ExternalVariableConnectorInterface1 {

	@Override
	public String getVariableName() { return "HALF_UP"; }
	@Override
	...
	public Object getData() throws ConnectorException {
		return Long.valueOf(FloatRoundXfci1Plugin.HALF_UP);
	}
