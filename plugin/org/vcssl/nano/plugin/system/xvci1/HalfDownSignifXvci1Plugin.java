...
public class HalfDownSignifXvci1Plugin implements ExternalVariableConnectorInterface1 {

	@Override
	public String getVariableName() { return "HALF_DOWN_SIGNIF"; }
	@Override
	...
	public Object getData() throws ConnectorException {
		return Long.valueOf(FloatRoundXfci1Plugin.HALF_DOWN_SIGNIF);
	}
