...
public class HalfToEvenXvci1Plugin implements ExternalVariableConnectorInterface1 {

	@Override
	public String getVariableName() { return "HALF_TO_EVEN"; }
	@Override
	...
	public Object getData() throws ConnectorException {
		return Long.valueOf(FloatRoundXfci1Plugin.HALF_TO_EVEN);
	}
