...
public class HalfToEvenSignifXvci1Plugin implements ExternalVariableConnectorInterface1 {

	@Override
	public String getVariableName() { return "HALF_TO_EVEN_SIGNIF"; }
	@Override
	...
	public Object getData() throws ConnectorException {
		return Long.valueOf(FloatRoundXfci1Plugin.HALF_TO_EVEN_SIGNIF);
	}
